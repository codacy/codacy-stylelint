...
**_Deprecated: Instead use the [`at-rule-property-required-list`](https://github.com/stylelint/stylelint/tree/13.7.0/lib/rules/at-rule-property-required-list/README.md) rule._**
