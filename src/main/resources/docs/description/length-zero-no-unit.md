...
This rule ignores lengths within math functions (e.g. `calc`) in favor of the [`function-calc-no-invalid`](https://github.com/stylelint/stylelint/tree/13.7.2/lib/rules/function-calc-no-invalid/README.md) rule.
