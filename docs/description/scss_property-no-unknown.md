...
The [`message` secondary option](https://github.com/stylelint-scss/stylelint-scss/7.2.0/docs/user-guide/configure.md#message) can accept the arguments of this rule.
