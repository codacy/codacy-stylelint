...
- [`color-no-invalid-hex`](https://github.com/stylelint/stylelint/tree/15.8.0/lib/rules/color-no-invalid-hex/README.md)
- [`function-no-unknown`](https://github.com/stylelint/stylelint/tree/15.8.0/lib/rules/function-no-unknown/README.md)
- [`string-no-newline`](https://github.com/stylelint/stylelint/tree/15.8.0/lib/rules/string-no-newline/README.md)
- [`unit-no-unknown`](https://github.com/stylelint/stylelint/tree/15.8.0/lib/rules/unit-no-unknown/README.md)
