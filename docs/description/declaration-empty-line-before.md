...
This rule only applies to standard property declarations. Use the [`custom-property-empty-line-before`](https://github.com/stylelint/stylelint/tree/14.16.1/lib/rules/custom-property-empty-line-before/README.md) rule for custom property declarations.
