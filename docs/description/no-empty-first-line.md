...
This rule ignores empty sources. Use the [`no-empty-source`](https://github.com/stylelint/stylelint/tree/15.10.1/lib/rules/no-empty-source/README.md) rule to disallow these.
