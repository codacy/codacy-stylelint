...
This rule supports 3 [message arguments](https://github.com/stylelint/stylelint/17.13.0/docs/user-guide/configure.md#message): the selector, the configured maximum specificity, and the selector's resolved form.
