...
This rule checks descriptors within at-rules. To check properties, you can use the [`property-no-unknown`](https://github.com/stylelint/stylelint/16.26.1/lib/rules/property-no-unknown/README.md) rule.

For customizing syntax, see the [`languageOptions`](https://github.com/stylelint/stylelint/16.26.1/docs/user-guide/configure.md#languageoptions) section.
