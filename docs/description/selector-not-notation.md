...
The [`fix` option](https://github.com/stylelint/stylelint/tree/15.10.1/docsuser-guideoptions.md#fix) option can automatically fix most of the problems reported by this rule.
